                ...
                >
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <motion.div variants={titleVariants} className="space-y-4">
                            <h1 className={`text-5xl md:text-7xl font-bold leading-tight bg-gradient-to-r bg-clip-text text-transparent ${
                                currentTheme === 'minimal'
                            ...
                            <div className={`text-2xl md:text-3xl font-medium h-12 flex items-center ${
                        ...
                        >
                            ...
                            <motion.a
                                href="#contact"
                                className={`group flex items-center gap-3 px-6 py-3 rounded-xl font-semibold border-2 transition-all duration-300 ${
                                    currentTheme === 'minimal'
                    ...
                    >
                            ...
                            {HERO_CONTENT.highlights.map((skill, index) => (
                                ...
                                >
                                    <div className={`w-2 h-2 rounded-full ${
                                        currentTheme === 'minimal' ? 'bg-gray-400' : 'bg-purple-400'
                                    }`} />
                        ...
                        <div className={`pt-6 border-t space-y-3 ${
                            currentTheme === 'minimal' ? 'border-gray-200' : 'border-neutral-700'
                        }`}>
