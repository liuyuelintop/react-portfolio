...
const Button = ({ 
  ...
  const variants = {
    primary: {
      default: "bg-white hover:bg-neutral-200 text-neutral-950 shadow-lg shadow-black/20 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0",
      ...
      minimal: "bg-gray-950 hover:bg-gray-800 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5",
      corporate: "bg-blue-700 hover:bg-blue-800 text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5"
    },
    secondary: {
      default: "border border-neutral-700 text-neutral-200 hover:bg-neutral-800 hover:border-neutral-600 hover:shadow-md",
      neon: "border border-cyan-400 text-cyan-400 hover:bg-cyan-950 hover:shadow-md hover:shadow-cyan-400/20",
      minimal: "border border-gray-300 text-gray-700 hover:bg-gray-50 hover:shadow-sm",
      corporate: "border border-blue-700 text-blue-700 hover:bg-blue-50 hover:shadow-sm"
    },
    ghost: {
      default: "text-neutral-300 hover:bg-neutral-800 hover:shadow-sm",
      neon: "text-cyan-400 hover:bg-cyan-950 hover:shadow-sm",
      minimal: "text-gray-700 hover:bg-gray-50 hover:shadow-sm",
